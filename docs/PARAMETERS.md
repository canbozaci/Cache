...
Release support assumes the timing and integration contract in `docs/TIMING_CONTRACT.md`, the native memory contract in `docs/NATIVE_MEMORY_PROTOCOL.md`, and the error propagation rules in `docs/ERROR_HANDLING.md`, including the single-request line-boundary rule and the documented instruction/data L1 coherency limitation.
